...
class agregarCategoria : AppCompatActivity() {
    ...
    private fun actualizarCategoria() {
        val url = "http://192.168.1.78:80/coffeeware/wsJSONActualizaCategoria.php?"
    ...
    fun agregarCategoria(){
        val url = "http://192.168.1.78:80/coffeeware/wsJSONRegistroCategorias.php?ID="+edtId.text.toString()+"&nombre="+edtNombre.text.toString()
