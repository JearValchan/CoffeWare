...
class agregarProducto : AppCompatActivity() {
    ...
    fun agregarProducto(){
        var url: String="http://192.168.1.65:80/coffeeware/wsJSONRegistroProducto.php?ID="+edtId.text.toString()+"&producto_type="+edtTipo.text.toString()+"&nombre="+edtNombre.text.toString()+"&preciobase="+edtPrecioBase.text.toString()+"&id_categoria="+edtCategoria.text.toString()
        url=url.replace(" ","%20")
    ...
    fun actualizarProducto(){
        ...
        var url: String="http://192.168.1.65:80/coffeeware/wsJSONActualizarProducto.php"
